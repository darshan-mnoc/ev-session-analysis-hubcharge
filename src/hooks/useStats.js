...
export const useStats = (filteredData) => {
  return useMemo(() => {
    ...
    return {
      ...
      avgPowerMBS1_400V: avgPowerFn(sessionsMBS1_400V).toFixed(1),
      avgPowerMBS1_800V: avgPowerFn(sessionsMBS1_800V).toFixed(1),
      avgPowerMBS2_400V: avgPowerFn(sessionsMBS2_400V).toFixed(1),
      avgPowerMBS2_800V: avgPowerFn(sessionsMBS2_800V).toFixed(1),
